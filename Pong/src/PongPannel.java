...
public class PongPannel extends JPanel implements ActionListener, KeyListener
{
	...
	private void paintSprite(Graphics g, Sprite sprite) {
		...
		g.fillRect(sprite.getxPosition(), sprite.getxPosition(), sprite.getWidth(), sprite.getHeight());
	}
	...
	private void moveObject (Sprite obj) {
		obj.setxPosition(obj.getxPosition() + obj.getxVelocity());
		obj.setyPosition(obj.getyPosition()+obj.getyVelocity());
	}
